    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".body-main-slider__slider")) new core(".body-main-slider__slider", {
                modules: [ Navigation, EffectFade, Autoplay, Lazy, Pagination, EffectCreative ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
            ...
            if (document.querySelector(".gallery__slider")) {
                ...
                function gallerySliderFix() {
                    ...
                    if (diff > 0) document.querySelector(".gallery__slider").style.width = document.querySelector(".gallery__body").offsetWidth + diff + "px"; else document.querySelector(".gallery__slider").style.width = document.querySelector(".gallery__body").offsetWidth + 15 + "px";
                }
        ...
        function bgParallax(params) {
            ...
            if (bgItems.length) document.addEventListener("windowScroll", (function(e) {
                bgItems.forEach((function(bgItem) {
                    ...
                    if (scrollY > bgItemPosition - window.innerHeight && scrollY < bgItemPosition + bgItemHeight) if (bgItemBg) bgItemBg.style.cssText = `transform: translate3D(0,${bgItemPositionValue}px,0);`;
                }));
            }));
        }
        setTimeout((() => {
        ...
        window.addEventListener("load", (function(e) {
            ...
            if (bg.length) bg.forEach((function(bgItem) {
            ...
            if (document.querySelector(".video-module")) {
                ...
                videoModule.addEventListener("click", (function(e) {
                    if (!videoModule.classList.contains("_init")) {
                        videoModule.querySelector("video").src = document.querySelector("video").dataset.full;
